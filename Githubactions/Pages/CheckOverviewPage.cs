...
using Githubactions.Locators;
using NUnit.Framework;
using Githubactions.Utilities;
...
namespace Githubactions.Pages
{
    public class CheckOverviewPage
    {
        ...
        public void OrderConfirm()
        {
            ...
            Assert.That(driver.FindElement(CheckutOverviewLocator.orderconfirm).Text, Is.EqualTo("Thank you for your order!"));
